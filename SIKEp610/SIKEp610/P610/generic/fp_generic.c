...
extern void add610_func(const digit_t* a, const digit_t* b, digit_t* c);
extern void sub610_func(const digit_t* a, const digit_t* b, digit_t* c);
extern void mul640_func(const digit_t* a, const digit_t* b, digit_t* c);
extern void rdc610_func(const digit_t* ma, digit_t* mc);
