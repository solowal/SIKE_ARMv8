...
extern void add434_func(const digit_t* a, const digit_t* b, digit_t* c);
extern void sub434_func(const digit_t* a, const digit_t* b, digit_t* c);
extern void mul448_func(const digit_t* a, const digit_t* b, digit_t* c);
extern void modmul434_func(const digit_t* a, const digit_t* b, digit_t* c);

extern void rdc434_func(const digit_t* ma, digit_t* mc);
...
void modmul434(const digit_t* a, const digit_t* b, digit_t* c){
    modmul434_func(a,b,c);
}
